...
# print("Cognito App Client ID:", COGNITO_APP_CLIENT_ID)
# print("Cognito App Client Secret:", COGNITO_APP_CLIENT_SECRET)
# print("Cognito User Pool ID:", COGNITO_USER_POOL_ID)
...
def register_user(user: UserCreate):
    ...
    try:
        ...
        model_get_or_create_user_profile(user.username, user.email, user.steam_id)
