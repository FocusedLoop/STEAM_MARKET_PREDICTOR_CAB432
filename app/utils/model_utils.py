...
class PriceModel:
    ...
    MODEL_DIR = os.path.join(BASE_DIR, "tmp/models/jobs/")
    SCALER_DIR = os.path.join(BASE_DIR, "tmp/models/scalers/")
    FEATURES_DIR = os.path.join(BASE_DIR, "tmp/models/features/")
